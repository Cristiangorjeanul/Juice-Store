document.addEventListener('DOMContentLoaded', function () {
	...
	var QuestionnaireFormat = {
		...
		showResults: function () {
			...
			if (grade >= 0.8) {
				results += '<h2>Thank you very much,<br>for your consideration!<br>It seems that you are satisfied<br>with the quality of our products!</h2>';
			} else if (grade < 0.8 && grade > 0.5) {
				results += '<h2>Thank you very much,<br>for your consideration!<br>It seems that you are not very satisfied<br>with the quality of our products!</h2>';
			} else {
				results += '<h2>Thank you very much,<br>for your consideration!<br>It seems that you are not satisfied<br>with the quality of our products!</h2>';
			}
